...
0000000000400da0 <main>:                                          # main method
  400da0:	53                   	push   %rbx
  ...
  400e3a:	e8 a1 00 00 00       	callq  400ee0 <phase_1>               # first phase
  400e3f:	e8 80 07 00 00       	callq  4015c4 <phase_defused>
  400e44:	bf a8 23 40 00       	mov    $0x4023a8,%edi
  400e49:	e8 c2 fc ff ff       	callq  400b10 <puts@plt>
  400e4e:	e8 4b 06 00 00       	callq  40149e <read_line>
  400e53:	48 89 c7             	mov    %rax,%rdi
  400e56:	e8 a1 00 00 00       	callq  400efc <phase_2>               # phase 2
  ...
  400ecb:	e8 f4 06 00 00       	callq  4015c4 <phase_defused>       # may call secret phase
...
0000000000400efc <phase_2>:
  ...
  400f02:	48 89 e6             	mov    %rsp,%rsi
                                                                        # 1. check array[0] = 1
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>        # - reads in 6 numbers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                      # - %rsp should point to 1 (array[0] = 1)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
                                                                        # 3. start of loop
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax                  # - set eax to the num before the num pointed by rbx
  400f1a:	01 c0                	add    %eax,%eax                        # - double eax
  400f1c:	39 03                	cmp    %eax,(%rbx)                      # - the double of eax should be num pointed by rbx
                                                                        # - i.e. array[rbx] = 2 * array[rbx-1]
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
                                                                        # 4. update loop and check loop condition
  400f25:	48 83 c3 04          	add    $0x4,%rbx                        # - move rbx forward (update for loop)
  400f29:	48 39 eb             	cmp    %rbp,%rbx                        # - check rbx has not reached end of 6-int array (end condition for loop)
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
                                                                        # 2. initialize for loop
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx                   # - rbx = rsp + 4   [index in the number array]
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp                  # - rbp = rsp + 24  [last index in 6-int array]
...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax                      # eax = number of units read by scanf.
                                                                      # setting a breakpoint here in gdb shows that
                                                                      # eax is 2 even when there are more than 2 units,
                                                                      # so we are expecting 2 units.
                                                                      # examining assembly code below and using gdb
                                                                      # shows us that *(rsp+8), *(rsp+0x0C) are the 2 inputs.
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                 # *(rsp+8) should be <= 7 [supposed *(rsp+8) = 7]
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>          # this jumps to explosion
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                 # eax = *(rsp+8) = 7
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)             # jump to location stored at 0x402470 + 56 = 0x4024A8
                                                                      # gdb shows that 0x4024A8 stores 0x400fa6
                                                                      # `x /x 0x4024A8` => show value at address in hex
  ...
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                    # jump to here: eax = 0x147
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                 # eax must == *(rsp+12), so 2nd input is 0x147=327
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax                  # eax = edx = 0x0e (from phase_4)
  400fd4:	29 f0                	sub    %esi,%eax                  # eax = esi = 0x0e (esi = 0 from phase_4)
  400fd6:	89 c1                	mov    %eax,%ecx                  # ecx = eax = 0x0e
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                 # shift ecx right by 0x1f (31)
  400fdb:	01 c8                	add    %ecx,%eax                  # eax += ecx
  400fdd:	d1 f8                	sar    %eax                       # eax /= 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx         # ecx = rsi + rax
                                                                  # In the first recursion, ecx = 7 now
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>        # if (ecx <= edi) jump to .L1
                                                                  # edi is first input, so first input <= ecx (7)
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx            
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>             
  400fee:	01 c0                	add    %eax,%eax                  
  400ff0:	eb 15                	jmp    401007 <func4+0x39>        
.L1:
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                  # eax = 0, WE NEED THIS IN PHASE 4
  400ff7:	39 f9                	cmp    %edi,%ecx
  400ff9:	7d 0c                	jge    401007 <func4+0x39>        # if (ecx >= edi) jump to end
                                                                  # note how we can disgard all the recursions as long as
                                                                  # both if statements (ecx>=edi and ecx<=edi) hold
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                 # rcx = rsp+0x0c
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                 # rdx = rsp+0x08
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax                      # eax = number of inputs = 2
                                                                      # using gdb shows *(rsp+8) stores input 1,
                                                                      # and *(rsp+0xC) stores input 2
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e>          # *(rsp+8) <= 0x0e [first input]
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                      # edx = 0x0e
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                      # esi = 0x0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                 # edi = *(rsp+8)
  401048:	e8 81 ff ff ff       	callq  400fce <func4>                 # calling func 4
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>          # eax == 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>          # *(rsp+0xc) == 0 [second input]
...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax                    # string length = 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>        # jump to .L1
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
.L2:
                                                                  # rax is index i here.
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx         # moving input char to ecx
  40108f:	88 0c 24             	mov    %cl,(%rsp)                 # moving input char to (rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                # moving input char to rdx
  401096:	83 e2 0f             	and    $0xf,%edx                  # get low 4 bytes
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx        # retrieve associated char at 
                                                                  # addr = 0x4024b0 + low 4 bytes of input char
                                                                  # print string at 0x4024b0 to find the chars we want ("flyers")
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)      # move the retrieved char to Mem[rsp+16+i]
  4010a4:	48 83 c0 01          	add    $0x1,%rax                  # increment index i
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>      # return to .L2 if index != 6
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)            # add null terminator to Mem[rsp+32]
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi            # rdi = pointer to string
                                                                  # (string is Mem[rsp+16] to Mem[rsp+32])
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal> # string comparison
                                                                  # breakpoint at strings_not_equal shows we want "flyers"
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>      # need this jump to exit loop
.L1:
...
00000000004010f4 <phase_6>:
  ...
  401100:	49 89 e5             	mov    %rsp,%r13                  # r13 = rsp (first input location)
                                                                  # (use index j, denote M[r13] = input[j])
                                                                  # start with j = 0
  401103:	48 89 e6             	mov    %rsp,%rsi
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>  # read 6 numbers
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                 # r12d = 0 (denote r12d = i = 0)
                                                                  # start with i = 0
  401114:	4c 89 ed             	mov    %r13,%rbp                  # rbp = r13 = rsp = j
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax             # eax = input[j]
  40111b:	83 e8 01             	sub    $0x1,%eax                  # eax = input[j] - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>      # eax must <= 5
                                                                  # so input[j] must <= 6 for all j
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
# go on to process the next 5 input numbers:
  401128:	41 83 c4 01          	add    $0x1,%r12d                 # increment r12d (increment i)
                                                                  # note that i will always be j + 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>      # if r12d (index i) == 6, jump to .L2
  401132:	44 89 e3             	mov    %r12d,%ebx                 # initialize ebx = i (ebx is another index)
.L3: # make sure input[i] to input[6] are not equal to input[j]
  401135:	48 63 c3             	movslq %ebx,%rax                  # rax = ebx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax         # eax = M[rsp+rax*4] (each input number)
                                                                  # essentially eax = input[i]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)             # M[rbp] = input[j]
  40113e:	75 05                	jne    401145 <phase_6+0x51>      # input[i] must != input[j]
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                  # ebx++
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>      # if ebx <= 5, jump to .L3
  40114d:	49 83 c5 04          	add    $0x4,%r13                  # increment index j
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
# The stuff above checks that:
#   1) all input numbers are <= 6
#   2) all input numbers are not equal to each other

.L2:
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi            # set rsi to end of input numbers
  401158:	4c 89 f0             	mov    %r14,%rax                  # rax = r14 (rax will serve as index)
                                                                  # (r14 is start of input, see 0x40110b)
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                  # ecx = 7
  401160:	89 ca                	mov    %ecx,%edx                  # edx = ecx = 7
  401162:	2b 10                	sub    (%rax),%edx                # edx = edx - M[rax] = 7 - each input number
  401164:	89 10                	mov    %edx,(%rax)                # M[rax] = edx = 7 - input number
                                                                  # Set each input = 7 - input
  401166:	48 83 c0 04          	add    $0x4,%rax                  # increment rax (index here)
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>      # continue with loop if necessary
# The stuff above changes each input: input = 7 - input

  40116f:	be 00 00 00 00       	mov    $0x0,%esi                  # esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>      # jump to .L7
.L1:
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx             # rdx = *(rdx+8) [repeat input[i]-1 times]
                        # rdx always starts as 0x6032d0 (input[i] <= 1)
                        # *(0x6032d0+8) = 0x6032e0      (input[i] = 2)
                        # *(0x6032e0+8) = 0x6032f0      (input[i] = 3)
                        # *(0x6032f0+8) = 0x603300      (input[i] = 4)
                        # *(0x603300+8) = 0x603310      (input[i] = 5)
                        # *(0x603310+8) = 0x603320      (input[i] = 6)
  40117a:	83 c0 01             	add    $0x1,%eax                  # eax++
  40117d:	39 c8                	cmp    %ecx,%eax                  # eax = input[i] yet?
  40117f:	75 f5                	jne    401176 <phase_6+0x82>      # not equal: continue loop
  401181:	eb 05                	jmp    401188 <phase_6+0x94>      # equal: exit loop
.L9:
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)     # M[rsp+2rsi+32] = rdx
                                                                  # recall rsi starts at 0, increments 4 at a time
                                                                  # and ends before 0x18 = 24.
                                                                  # this gives an array from M[rsp+32] to M[rsp+40+32],
                                                                  # with 6 elements, each of which takes 8 bytes
                                                                  # The values in this array are from line 0x401176
  40118d:	48 83 c6 04          	add    $0x4,%rsi                  # increment rsi means move on to next input[i]
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                 # end point where rsi = 24
  401195:	74 14                	je     4011ab <phase_6+0xb7>      # if rsi reached 24, exit loop to .L8

.L7:
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx         # ecx = M[rsp + rsi] = each input[i]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                  # 
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>      # if ecx (input[i]) <= 1, jump to .L9
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                  # eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx             # edx = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>      # jump to .L1

.L8:
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx            # rbx = M[rsp+32] = first element of array
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax            # rax = rsp + 40 = index i of loop
                                                                  # starting with i = 1
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi            # rsi = rsp + 80 (end point of loop)
  4011ba:	48 89 d9             	mov    %rbx,%rcx                  # rcx = rbx = M[rsp+32] = array[0]

  4011bd:	48 8b 10             	mov    (%rax),%rdx                # rdx = M[rax] = array[i]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)             # set M[rcx+8] to M[rax] = array[i]
              # this is essentially *(array[i-1] + 8) = array[i], for i = 1 to 5
  4011c4:	48 83 c0 08          	add    $0x8,%rax                  # rax = rax + 8, increment index i
  4011c8:	48 39 f0             	cmp    %rsi,%rax                  # has rax reached endpoint?
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>      # exit loop
  4011cd:	48 89 d1             	mov    %rdx,%rcx                  # rcx = rdx = M[rax] = array[i]
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>      # jump back to loop

  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)             # M[rdx+8] = 0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                  # ebp = 5
.L5:
                                                                  # rbx starts off as array[0], i = 0
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax             # rax = M[rbx+8]
                                                                  # so rax = array[i+1] by def of the array
  4011e3:	8b 00                	mov    (%rax),%eax                # eax = M[rax] = M[ array[i+1] ]
  4011e5:	39 03                	cmp    %eax,(%rbx)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>      # M[rbx] must >= eax
                                                                  # so M[array[i]] >= M[array[i+1]]
                                                                  # we can use this to order our array
  # input[i]    <=1       2         3         4         5         6
  # array[i]    0x6032d0  0x6032e0  0x6032f0  0x603300  0x603310  0x603320
  # M[array[i]] 332       168       924       691       477       443

  # Sort M[array[i]] in descending order:
  #             924       691       477       433       332       168
  # input[i]:   3         4         5         6         <=1       2
  # Remember that we had done input[i] = 7 - input[i], so reversing this we get:
  #             4         3         2         1         6         5
  #   The reason we have 6 instead of >=6 is because all input[i] has to be <= 6

  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx             # rbx = M[rbx+8]
                                                                  # so rbx = array[i+1] by definition of the array
  4011f2:	83 ed 01             	sub    $0x1,%ebp                  # ebp--
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>      # ebp != 0 then jump .L5
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx                        # rbx = pointer to input string 1
  40133f:	48 89 f5             	mov    %rsi,%rbp                        # rbp = pointer to input string 2
...
000000000040145c <read_six_numbers>:
  ...
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                 # M[rsp+8] = rax = rsi + 20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                # rax = rsi + 16
  401474:	48 89 04 24          	mov    %rax,(%rsp)                    # M[rsp] = rax = rsi + 16
...
00000000004015c4 <phase_defused>:
  ...
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings>
                                                                  # checks if it has received 6 input strings
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b>
  4015e1:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8             # M[r8] = 1
  4015e6:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx             # M[rcx] = 6
  4015eb:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx             # M[rdx] = 5
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi               # *edi = "7 0"
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax                    # input length must = 3
  401602:	75 31                	jne    401635 <phase_defused+0x71>
  401604:	be 22 26 40 00       	mov    $0x402622,%esi               # *esi = "DrEvil"
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi              # 1??
